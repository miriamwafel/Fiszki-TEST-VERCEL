...
export function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-sm border-b" aria-label="Nawigacja główna">
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div id="mobile-menu" className="sm:hidden border-t" role="navigation" aria-label="Menu mobilne">
